Building Bewcore Core with Visual Studio
========================================

Introduction
---------------------
Visual Studio 2022 is minimum required to build Bewcore Core.

Solution and project files to build with `msbuild` or Visual Studio can be found in the `build_msvc` directory.

To build Bewcore Core from the command-line, it is sufficient to only install the [Visual Studio Build Tools](https://visualstudio.microsoft.com/downloads/) component.
...
Qt
---------------------
To build Bewcore Core with the GUI, a static build of Qt is required.
...
To build Bewcore Core without Qt, unload or disable the `bewcore-qt`, `libbitcoin_qt` and `test_bewcore-qt` projects.
