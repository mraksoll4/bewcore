# Fuzzing Bewcore Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Bewcore Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
## Overview of Bewcore Core fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/bitcoin_report.pdf) includes an external overview of the status of Bewcore Core fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.
...
Every single pull request submitted against the Bewcore Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bewcore Core more robust.
...
with certain assembly code from Bewcore Core's code. See [developer notes on sanitizers](https://github.com/mraksoll4/bewcore/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Bewcore Core using afl++

## Quickstart guide

To quickly get started fuzzing Bewcore Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Bewcore Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Bewcore Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the Bewcore Core P2P layer using Honggfuzz NetDriver
...
```sh
$ mkdir bewcore-honggfuzz-p2p/
$ cd bewcore-honggfuzz-p2p/
$ git clone https://github.com/mraksoll4/bewcore
$ cd bewcore/
$ ./autogen.sh
$ git clone https://github.com/google/honggfuzz
...
# Fuzzing Bewcore Core using Eclipser (v1.x)

## Quickstart guide

To quickly get started fuzzing Bewcore Core using [Eclipser v1.x](https://github.com/SoftSec-KAIST/Eclipser/tree/v1.x):
...
Bewcore Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
