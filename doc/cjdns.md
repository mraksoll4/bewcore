# CJDNS support in Bewcore Core

It is possible to run Bewcore Core over CJDNS, an encrypted IPv6 network that
...
done outside of Bewcore Core, similarly to a VPN (either in the host/OS or on
...
before it will work with your Bewcore Core node. This is described in steps
...
## Run Bewcore Core with CJDNS

Once you are connected to the CJDNS network, the following Bewcore Core
...
When enabled, this option tells Bewcore Core that it is running in an
...
IPv6 local network. This helps Bewcore Core perform better address management:
...
CJDNS support was added to Bewcore Core in version 23.0 and there may be fewer
...
## CJDNS-related information in Bewcore Core

There are several ways to see your CJDNS address in Bewcore Core:
