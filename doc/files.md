...
The data directory is the default location where the Bewcore Core files are stored.
...
These subdirectories and files are no longer used by Bewcore Core:
