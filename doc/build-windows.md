...
Below are some notes on how to build Bewcore Core for Windows.

The options known to work for building Bewcore Core on Windows are:
...
Note that for WSL the Bewcore Core source path MUST be somewhere in the default mount file system, for
