When Bewcore Core automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by Bewcore Core,
...
Below is a list of "bad" ports which Bewcore Core avoids when choosing a peer to
