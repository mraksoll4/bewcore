UNIX BUILD NOTES
====================
Some notes on how to build Bewcore Core in Unix.
...
memory available when compiling Bewcore Core. On systems with less, gcc can be
...
To build Bewcore Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Bewcore Core can
