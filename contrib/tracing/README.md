...
Tracing (USDT) support for Bewcore Core on Linux using. For more information on
USDT support in Bewcore Core see the [USDT documentation].
...
[Bewcore Core USDT documentation] on how to list available tracepoints in your
`bewcored` binary.

[Bewcore Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
In a different terminal, starting Bewcore Core in SigNet mode and with
re-indexing enabled.
