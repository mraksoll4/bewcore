Contributing to Bewcore Core
============================

The Bewcore Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Bewcore Core
...
Before you start contributing, familiarize yourself with the Bewcore Core build
system and tests. Refer to the documentation in the repository on how to build
Bewcore Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Bewcore Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Bewcore Core development happens on IRC, in the
...
For all other issues and pull requests, the https://github.com/meraksoll/bewcore node repository should be used.
...
fork of Bewcore Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Bewcore Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitcoin
Network Protocol consensus changes.

Whether a pull request is merged into Bewcore Core rests with the project merge
maintainers.
